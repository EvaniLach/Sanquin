...
argparser.add_argument("--nn", default=[64, 64, 128, 128], type=int, nargs='+', help="layer sizes")
...
argparser.add_argument("--episodes", default=50, type=int, help="number of episodes")

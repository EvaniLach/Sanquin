...
def main():
    ...
    paths = [
        "results", f"results/{SETTINGS.model_name}", f"results/{SETTINGS.model_name}/learning_rates", f"results/{SETTINGS.model_name}/learning_rates/a{SETTINGS.alpha}",
        "models", f"models/{SETTINGS.model_name}", f"models/{SETTINGS.model_name}/learning_rates", f"models/{SETTINGS.model_name}/learning_rates/a{SETTINGS.alpha}"]
    for path in paths:
